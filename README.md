...
The current v0.5 baseline provides:
...
The QFLASH area at `0x08000000` contains ROM-managed key and parameter data. It is not described here as silicon eFuse or OTP.
